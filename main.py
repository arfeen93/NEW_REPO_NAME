...
"""single gpu params"""
device_id, device = 0, torch.device("cuda:0")
...
# Connecting 10.64.34.33 for dataset accessing from mnt folder
# host = "10.64.34.33"
# port = 22
# username = "arfeen"
# password = "arfeen"
...
for r in range(args.runs):
    ...
    for e in tqdm(range(0, configs['epochs'])):
        ...
        accuracy, test_fix_embed, test_embeddings, target_pred = test(method, test_dataset, attributes, tst_cls_lbl, zsl=args.zsl)
